...
<code>Classroom</code> class, three instances of the <code>Wilder</code> object must be created and the instance method is called to check if thoses instances are
aware or not.
